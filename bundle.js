...
},{"./views/index.jsx":29,"react":28,"react-dom":25}],2:[function(require,module,exports){
/**
...
},{"./lib/ReactPropTypesSecret":22,"_process":17,"fbjs/lib/invariant":11,"fbjs/lib/warning":15}],19:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":22,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":11}],20:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":18,"./lib/ReactPropTypesSecret":22,"_process":17,"fbjs/lib/emptyFunction":6,"fbjs/lib/invariant":11,"fbjs/lib/warning":15,"object-assign":16}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"fbjs/lib/ExecutionEnvironment":2,"fbjs/lib/containsNode":5,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/getActiveElement":8,"fbjs/lib/invariant":11,"fbjs/lib/shallowEqual":14,"object-assign":16,"react":28}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":17,"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":11,"fbjs/lib/warning":15,"object-assign":16,"prop-types/checkPropTypes":18}],27:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":6,"fbjs/lib/emptyObject":7,"fbjs/lib/invariant":11,"object-assign":16}],28:[function(require,module,exports){
(function (process){
'use strict';
...
var _todoListJsx = require('./todoList.jsx');

var _todoListJsx2 = _interopRequireDefault(_todoListJsx);

var _todoFormJsx = require('./todoForm.jsx');
...
var TodoBox = (function (_React$Component) {
	...
	function TodoBox() {
		...
		_get(Object.getPrototypeOf(TodoBox.prototype), 'constructor', this).apply(this, arguments);
	}
	...
	_createClass(TodoBox, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(_todoListJsx2['default'], { data: this.props.data }),
				_react2['default'].createElement(_todoFormJsx2['default'], null)
			);
		}
	}]);
...
},{"./todoForm.jsx":30,"./todoList.jsx":31,"react":28}],30:[function(require,module,exports){
"use strict";
...
var TodoForm = (function (_React$Component) {
  ...
  function TodoForm() {
    ...
    _get(Object.getPrototypeOf(TodoForm.prototype), "constructor", this).apply(this, arguments);
  }
...
},{"react":28}],31:[function(require,module,exports){
'use strict';
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement('input', { type: 'checkbox', checked: this.state.checked, onChange: this.handleChange.bind(this) })
        ),
        _react2['default'].createElement(
          'td',
          { style: style.tableContent },
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      var todos = this.props.data.map(function (todo) {
        return _react2['default'].createElement(Todo, { title: todo.title, key: todo.title, detail: todo.detail });
      });
      return _react2['default'].createElement(
        'div',
        { className: 'todoList' },
